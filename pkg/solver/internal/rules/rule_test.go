...
func TestAllRule(t *testing.T) {
	tests := []struct {
		...
		{rules.BlockSatisfiedRule{}, []game.Cell{U}, []int{1, 1}, nil},
		{rules.BlockSatisfiedRule{}, []game.Cell{U, B, U}, []int{1}, []game.Cell{W, B, W}},
		{rules.BlockSatisfiedRule{}, []game.Cell{U, U, B, B, U, U}, []int{2}, []game.Cell{U, W, B, B, W, U}},
		{rules.BlockSatisfiedRule{}, []game.Cell{B, U, U, B, B, U}, []int{1, 2}, []game.Cell{B, U, W, B, B, W}},
